    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Card(
            child: Column(children: [
              _RadioTile<String>(
                ...
                value: 'haas',
                groupValue: dialect,
                onChanged: _setDialect,
              ),
              const Divider(height: 1, color: AppColors.border),
              _RadioTile<String>(
                title: 'Siemens Sinumerik',
                subtitle: 'Sinumerik 840D / 828D',
                value: 'sinumerik',
                groupValue: dialect,
                onChanged: _setDialect,
              ),
          ...
          // Theme (informational only — always dark)
